import { HoverBorderGradientDemo } from "@/components/AccButton";
...
export default function Home(){
  return(
    <div className="min-h-screen w-full bg-neutral-950 relative flex flex-col items-center justify-center antialiased select-none">
      <NavbarDemo/>
